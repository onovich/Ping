...
namespace Ping {
    public static class UIApp {
        ...
        // Panel - Score
        public static void Score_Open(UIAppContext ctx, string player1Name, string player2Name, int ownerIndex) {
            PanelScoreDomain.Open(ctx, player1Name, player2Name, ownerIndex);
        }
